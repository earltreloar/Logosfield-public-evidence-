...
## The Remembering Cosmos Manuscript

The full theoretical foundation of **ODCCT** and **Logosfield** is now in the repo:

📖 [**Read the manuscript (PDF)**] [(./manuscript/the_remembering_cosmos.pdf)](https://github.com/earltreloar/Logosfield-public-evidence-/blob/main/manuscript/the_remembering_cosmos.pdf)
