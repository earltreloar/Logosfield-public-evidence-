...
- **M3 (Sacred sites):** validated proximity advantage vs matched nulls; numbers in bundle.
- **M14 (Archetypes):** Fisher combined p ≈ 1.9×10⁻¹² (10 traits).
- **CDDR:** η ≈ 0.95–0.98 with fixed r_d=147.05; best‑fit r_d: SDSS ~132.4±1.5, DESI ~115.3±1.2 (Lyα caution).
- **SMBH:** with A_t=−0.15, z_t=7.0, Δz=0.6 all seeds feasible under Logosfield; ΛCDM strict is tighter.
